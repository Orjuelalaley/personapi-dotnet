...
namespace personapi_dotnet.Controllers.MVC
{
    public class PersonasMVCController : Controller
    {
        ...
        public PersonasMVCController(PersonaDbContext context)
        {
            _context = context;
        }
        ...
        // GET: PersonasMVC/Create
        public IActionResult Create()
        {
            return View();
        }

        // POST: PersonasMVC/Create
