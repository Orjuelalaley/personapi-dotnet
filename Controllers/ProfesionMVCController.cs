...
namespace personapi_dotnet.Controllers.MVC
{
    public class ProfesionMVCController : Controller
    {
        ...
        // GET: ProfesionMVC/Create
        public IActionResult Create()
        {
            return View();
        }

        // POST: ProfesionMVC/Create
